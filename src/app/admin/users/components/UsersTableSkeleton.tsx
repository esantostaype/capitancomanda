...
export const UsersTableSkeleton = ( { isOwner = false }: Props ) => {
      ...
      <table className="w-full">
        <thead>
          <tr>
            ...
            <th className="bg-background px-6 py-4 text-left border-b-2 border-b-gray50 first:w-12 uppercase">Nombre Completo</th>
            <th className="bg-background px-6 py-4 text-left border-b-2 border-b-gray50 first:w-12 uppercase">Correo Electrónico</th>
            <th className="bg-background px-6 py-4 text-left border-b-2 border-b-gray50 first:w-12 uppercase">Rol</th>
